	      ...
	      <table class="table table-hover" align="center">
	         ...
	         <tbody> 
	        	 				...
	        	 				<td>${chatRoom.title }
	        	 					<c:if test="${!empty loginUser }">
		        	 					<button class="btn btn-primary"
		        	 					 onclick="location.href='${contextPath}/chat/room/${chatRoom.chatRoomNo }'"
		        	 					>참여</button>
	        	 					</c:if>
	        	 				</td>
                 ...
                 <!-- <tr>
			         <td>1</td>
			         <td>거지방
			         	<button class="btn btn-primary" onclick="">참여</button>
			         </td>
			         <td>
			         	박지현
			         </td>
	      ...
	      <div class="modal-content">
	         ...
	         <form action="${contextPath}/chat/openChatRoom" method="post">
	            ...
	            <div class="modal-body">
	               ...
	               <input type="text" class="form-controll mb-2 mr-sm-2" placeholder="채팅방 제목" id="chatRoomTitle" name="title"> 
	            </div>
