   ...
   <div id="container">
      ...
      <section id="content">
            ...
            <script>
               function displayResultTable(id, data){
                  ...
                  let html ="<table class='table'>";
                     ...
                     if(data.length > 0){ // mybatis selectList데이터가 없는 경우 빈 list를 리턴
         ...
         <script>
            ...
            // menu["id"] = 1;
               ...
               $.ajax({
                  ...
                  method : "PUT",
                  data : JSON.stringify(menu),
                  contentType : "application/json; charset=UTF-8", // 중요
                  success(data){
                     console.log(data);
                     const {msg} = data;
                     alert(msg);
         ...
         <div class="menu-test">
          ...
          <!-- 전송방식 delete로 요청 
                성공 시 -> 메뉴 삭제에 성공했습니다
                존재하지 않는 메뉴번호 입력 경우 -> 해당 메뉴가 존재하지 않습니다
                그 외) 메뉴 삭제에 실패했습니다
          -->
          <script>
