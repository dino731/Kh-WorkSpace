...
<%
	...
	// 게시글번호, 카테고리이름, 게시글제목, 내용, 작성자 아이디, 작성일
	...
	<div class="outer">
		...
		<div align="center">
			...
			<a href="<%= contextPath %>/update.bo?bno=<%=b.getBoardNo() %>"
				...
				href="<%= contextPath %>/delete.bo?bno=<%=b.getBoardNo() %>"
		...
		<div id="replay-area">
			<table border="1" align="center">
				<thead>
					...
					<tr>
						<th>댓글작성</th>
						<td><textarea rows="3" cols="50" style="resize: none;"
					...
					<tr>
						<th>댓글작성</th>
						<td><textarea rows="3" cols="50" style="resize: none;"
								readonly>로그인후 이용가능한 서비스입니다.</textarea></td>
						<td>
