                    ...
                    <form id="filterForm" action="" method="post"> <!-- 서버 URL을 적절히 수정해야 합니다 -->
                        <ul class="pl_filter_wrap">
                            ...
                            <li>
                                ...
                                <label class="pl_filter01" for="category<%= category %>"><%= category %>
                                </label>
                            </li>
                            <% } %>
                            ...
                            <li>
                                ...
                                <label class="pl_filter01" for="keyword<%= keyword %>"><%= keyword %>
                                </label>
                        ...
                        <input
                                ...
                                style="background-color: #ff8551; margin-left: 4px"
                                id="filterButton"
                        />
