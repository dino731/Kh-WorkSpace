      ...
      <div class="user-login-container">
        ...
        <div class="user-login-condition-wapper">
          ...
          <div class="user-login-condition-contents">
            ...
            <pre style=" font-size: 14px;">제 1조 (목적)
본 약관은 타임포메이커(이하 '회사'라 합니다)가 
운영하는 홈페이지(이하 '사이트'라 합니다)를 통해 
제공하는 모든 서비스에 대하여 회원과 회사의 권리, 
의무, 책임 및 기타 필요한 사항을 규정함을 목적으로 합니다.

제 2조 (약관의 효력 및 변경)
본 약관은 회원이 가입 시 동의함으로써 효력이 발생합니다.
회사는 필요한 경우 본 약관을 변경할 수 있으며, 
변경된 약관은 사이트를 통해 공지합니다.
변경된 약관은 공지 즉시 효력이 발생되며, 
회원은 변경된 약관에 대해 동의하지 않을 경우 회원탈퇴를 
선택할 수 있습니다. 변경된 약관에 동의하거나 
이용 계속으로 본 약관의 효력을 인정하는 것으로 간주됩니다.
            </pre>
          </div>
          <!-- 약관 문구 끝-->

          <div class="user-login-title-wapper">
            <span class="user-login-condition-title">개인정보 약관 동의</span>
            <span class="user-login-condition-must">(필수)</span>
          </div>
           <!-- 약관 문구 시작-->
          <div class="user-login-condition-contents">
            <p style="font-weight: 600; font-size: 17px;" >제 1장 총칙</p>
              <p style="font-size: 14px;">제 1조 (개인정보의 처리 목적)</p>
            <p style="font-weight: 600; font-size: 17px;">개인정보 처리방침</p>
            <pre style="font-size: 14px;">
제 1조 (개인정보의 처리 목적)

회사는 회원들의 개인정보를 다음의 목적으로 처리합니다.
가. 회원가입 및 서비스 제공을 위한 계약 이행
나. 서비스 제공 및 운영, 관리, 개선을 위한 목적
다. 서비스 이용에 따른 본인 식별 및 인증
마. 서비스 이용에 따른 요금 정산 및 결제 처리
바. 서비스 이용에 따른 통계 및 분석을 위한 목적
사. 회원의 개인정보 보호를 위한 법령 준수
아. 기타 회사가 정한 서비스 이용 목적에 따른 목적
            </pre>
            <!-- 약관 문구 끝-->
