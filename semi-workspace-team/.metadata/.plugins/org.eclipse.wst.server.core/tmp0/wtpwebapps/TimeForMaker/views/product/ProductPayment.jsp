...
<%
    ...
    String selectedPerson = (String) session.getAttribute("selectedPerson");
    int selectedPersonInt = Integer.parseInt(selectedPerson);
...
<%--                        <input type="hidden" name="RESERVATION_NO" value="reservation_seq.NEXTVAL">--%>
                            <input type="hidden" name="RESERVATION_NO" value="1">
                        ...
                        <%--예약시간--%>
                        <input type="hidden" name="RESERVATION_TIME" value="'13'">
                        <%--    결제여부--%>
<%--                        <input type="hidden" name="PAYMENT_STATUS" value="결제대기">--%>
                            <input type="hidden" name="PAYMENT_STATUS" value="결제완료">
                        <%--    유저넘버--%>
                        <input type="hidden" name="USER_NUM" value="82">
                        <%--    유저아이디--%>
