...
<link rel="shortcut icon" type="icon"
	href="/TimeForMaker/img/TFM_icon.png">
	...
	<div class="main_all">
						...
						<a href=""> <!-- 여기로 경로 표시 -->
							<div class="main_recom_item_img">
								<img class="card-img rounded-0 img-fluid"
									src="/TimeForMaker/assets/img/classimg/c_9_1.JPG">
							</div>
							<div class="main_recom_item_body">
								<br> <a class="main_class_name">클래스이름111</a>
				...
				<div class="main_recom_item_bar">	
					<%for (UserKeyword uk : recomlist) {%>
						...
						<div class="main_recom_item_wap">
							...
							<div class="main_recom_item_body">
								<br> <a class="main_class_name"><%=uk.getClassName()%></a>
								<ul class="main_class_key">
		...
		<div class="main_allclass_btnarea">
			<button class="main_allbtn"
				onclick="window.location.href='<%=contextPath%>/views/product/productList.jsp'">
				더많은 클래스 보기</button>
		</div>
		<!-- 추천끝 -->
	</div>
