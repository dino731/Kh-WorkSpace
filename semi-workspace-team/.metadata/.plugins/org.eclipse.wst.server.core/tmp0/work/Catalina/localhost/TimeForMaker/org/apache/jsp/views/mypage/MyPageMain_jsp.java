 ...
 * Generated at: 2023-07-20 07:02:04 UTC
...
public final class MyPageMain_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
      ...
      out.write("                url : '");
      out.print(contextPath);
      out.write("/mymainreserv.me', // 요청을 보낼 서블릿 경로\r\n");
      out.write("                data : {\"userId\" : userId},\r\n");
      out.write("                success : function(data) {\r\n");
      out.write("                	console.log(\"요청 성공: \" + data);\r\n");
      out.write("                	sessionStorage.setItem(\"mmrlist\", data);\r\n");
      out.write("                },\r\n");
      ...
      out.write("            url : '");
      out.print(contextPath);
      out.write("/mymaindone.me', // 요청을 보낼 서블릿 경로\r\n");
      out.write("            data : {\"userId\" : userId},\r\n");
      out.write("            success : function(data) {\r\n");
      out.write("            	console.log(\"요청 성공: \" + data);\r\n");
      out.write("            	sessionStorage.setItem(\"mdonelist\", data);\r\n");
      out.write("            },\r\n");
      out.write("            error : function(xhr, status, error) {\r\n");
      out.write("                console.log(\"Ajax 요청 에러: \" + error);\r\n");
      out.write("            }\r\n");
...
if(managerType.equals("M")){ 
      ...
      out.write("				                    <a class=\"main_admin_link\" href=\"");
      out.print( contextPath );
      out.write("/noticeBoard\">고객센터관리</a>\r\n");
      out.write("				                </li>\r\n");
      out.write("				            </div>\r\n");
      out.write("				        </div>\r\n");
      out.write("				  ");
 ...
 if (loginUser != null) { 
      ...
      out.write("				<!-- <img class=\"mypage-profile-image\" src=\"path/to/profile-image.jpg\" alt=\"프로필 사진\"> -->\r\n");
      ...
      out.write("					<div class=\"mypage-list-menu\">\r\n");
      out.write("						<a href=\"");
      out.print( contextPath);
      out.write("/views/mypage/MyPageMain.jsp\">방문 내역</a>\r\n");
      out.write("						<div class=\"mypage-list-line1\"></div>\r\n");
      out.write("					</div>\r\n");
      out.write("					<div class=\"mypage-list-menu\">\r\n");
      out.write("						<a href=\"");
      out.print( contextPath);
      out.write("/views/mypage/MyPageReservStatus.jsp\">나의 예약</a>\r\n");
      out.write("						<div class=\"mypage-list-line2\"></div>\r\n");
      out.write("					</div>\r\n");
      out.write("					<div class=\"mypage-list-menu\">\r\n");
      out.write("						<a href=\"");
      out.print( contextPath);
      out.write("/views/mypage/MyPageEditInfo.jsp\">내\r\n");
      out.write("							정보 수정</a>\r\n");
      out.write("						<div class=\"mypage-list-line3\"></div>\r\n");
      out.write("					</div>\r\n");
      out.write("				</div>\r\n");
      out.write("\r\n");
      out.write("			</div>\r\n");
 ...
 for(int i = 0; i<mmrlist.size(); i++){ 
      ...
      out.print(mmrlist.get(i).getProductNo());
      out.write("'\">\r\n");
      out.write("							<img src=\"");
      out.print(contextPath );
      out.print( mmrlist.get(i).getFileSavePath() );
      out.print( mmrlist.get(i).getFileName());
      out.write("\">\r\n");
      out.write("							\r\n");
      out.write("						</div>\r\n");
      ...
      out.write('"');
      out.write('>');
      out.print( mmrlist.get(i).getClassName() );
      out.write("</span> <br> \r\n");
      out.write("							<span class=\"mypage-appointment-list-keyword\">");
      out.print( mmrlist.get(i).getClassKeyword() );
      out.write("</span> \r\n");
      out.write("							<br> \r\n");
      out.write("								<span class=\"mypage-appointment-list-time\">");
      out.print( mmrlist.get(i).getReservationDate() );
      out.write("&ensp;");
      out.print( mmrlist.get(i).getReservationTime() );
      out.write(" </span> &ensp;\r\n");
      out.write("								<span class=\"mypage-appointment-list-rpeople\"> ");
      out.print( mmrlist.get(i).getUserNum() );
      out.write("명\r\n");
      out.write("							</span>\r\n");
      out.write("						</div>\r\n");
      out.write("						<div class=\"mypage-appointment-list-cancel\">\r\n");
      out.write("							<button class=\"mypage-btn-cancel\" onclick=\"mypage_delete();\">결제취소</button>\r\n");
      out.write("						</div>\r\n");
      out.write("					</div>\r\n");
      out.write("					");
 } 
 ...
 for(int i = 0; i<mdonelist.size(); i++){ 
      ...
      out.print(contextPath);
      out.write("/detail.product?pno=");
      out.print(mdonelist.get(i).getProductNo());
      out.write("'\">\r\n");
      out.write("								<img src=\"");
      out.print(contextPath );
      out.print( mdonelist.get(i).getFileSavePath() );
      out.print( mdonelist.get(i).getFileName());
      out.write("\">\r\n");
      out.write("							</div>\r\n");
      out.write("							<div class=\"mypage-appointment-text-container\">\r\n");
      out.write("								<span class=\"mypage-appointment-list-title\" onclick=\"location.href='");
      ...
      out.write('"');
      out.write('>');
      out.print( mdonelist.get(i).getClassName() );
      out.write("</span> <br> \r\n");
      out.write("								<span class=\"mypage-appointment-list-keyword\">");
      out.print( mdonelist.get(i).getClassKeyword() );
      out.write("</span> \r\n");
      out.write("								<br> \r\n");
      out.write("									<span class=\"mypage-appointment-list-time\">");
      out.print( mdonelist.get(i).getReservationDate() );
      out.write("&ensp;");
      out.print( mdonelist.get(i).getReservationTime() );
      out.write(" </span> &ensp;\r\n");
      out.write("									<span class=\"mypage-appointment-list-rpeople\"> ");
      out.print( mdonelist.get(i).getUserNum() );
      out.write("명\r\n");
      out.write("								</span>\r\n");
      out.write("							</div>\r\n");
      out.write("							\r\n");
 ...
 session.removeAttribute("mmrlist"); 
      out.write("\r\n");
      out.write("					\r\n");
      out.write("				</div> <!-- mypage-appointment-list-wrapper  -->\r\n");
      out.write("				\r\n");
      out.write("			</div>\r\n");
      out.write("			\r\n");
      out.write("				\r\n");
      ...
      out.write("				<div class=\"mypage_delete_more_check\">\r\n");
      out.write("					<br> <b>결제를 취소합니까?</b><br>\r\n");
      out.write("					<button class=\"mypage_delete_more_check_yes\"\r\n");
      out.write("						onclick=\"mypage_delete_more_check_yes();\">예</button>\r\n");
      out.write("					<button class=\"mypage_delete_more_check_no\"\r\n");
      out.write("						onclick=\"mypage_delete_more_check_no();\">아니요</button>\r\n");
      out.write("				</div>\r\n");
      out.write("			</div>\r\n");
